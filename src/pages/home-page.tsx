    ...
    return (
        <div id="home-page">
            ...
            <main className={styles.main}>
                ...
                <center><HighlightLabel>About Me</HighlightLabel></center>
                <Bio mt={2} mb={5} />
                <center><HighlightLabel mt={8} mb={6}>Contact Links</HighlightLabel></center>
                <Block style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "20px" }} mb={10}>
                    <LinkedInButton />
                    <EmailButton />
                </Block>
                <Footer mb={15} />
                <center><HighlightLabel mb={6} reverse={true}>Back To Top</HighlightLabel></center>
            </main>
        </div>
    );
};
